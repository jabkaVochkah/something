...
# Эти строки активируют и настраивают UFW.
# Используйте этот скрипт ТОЛЬКО если вы не используете другой фаервол (например, от скрипта VPN)
...
echo "Фаервол UFW настроен и активирован. Разрешены порты 22, 80, 443."
